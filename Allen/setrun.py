...
def setgeo(rundata):
    ...
    clawutil.data.get_remote_file(
                   "http://ftp.nhc.noaa.gov/atcf/archive/1980/bal041980.dat.gz")
    atcf_path = os.path.join(scratch_dir, "bal041980.dat")
    ...
    # "Landfall" for Allen 0000 UTC August 4 (Barbados)
    storm.time_offset = datetime.datetime(1980, 8, 4, 0)
