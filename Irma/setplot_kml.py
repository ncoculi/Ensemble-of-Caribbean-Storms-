...
#--------------------------
    ...
    #-----------------------------------------
    plotdata.kml_name = "Irma"
    plotdata.kml_starttime = [2017,9,6,18,0,0]  # Time of event in UTC [None]
    plotdata.kml_tz_offset = 5    # Time zone offset (in hours) of event. [None]

    plotdata.kml_index_fname = "Irma"  # name for .kmz and .kml files ["_GoogleEarth"]
    ...
    plotfigure.kml_xlimits = [-100,-40]
    plotfigure.kml_ylimits = [0.0, 60];
    ...
    plotfigure.kml_dpi = rcl*2*2*2*2         # Resolve all three levels
    ...
    plotfigure.kml_xlimits = [-90,-40]
    plotfigure.kml_ylimits = [0,40]
