...
def setgeo(rundata):
    ...
    clawutil.data.get_remote_file(
                   "http://ftp.nhc.noaa.gov/atcf/archive/2008/bal072008.dat.gz")
    atcf_path = os.path.join(scratch_dir, "bal072008.dat")
    ...
    # Because of its small diameter, Iris produced heavy damage only in a 70 mi (110 km) area of southern Belize. In that region, the hurricane produced a storm surge of up to 15 ft (4.6 m),[3] with waves of over 13 ft (4.0 m) in height,[21] causing street flooding and some damage to the offshore cayes.
    # Iris made landfall on Belize at 2:00 UTC on October 9, 2001
    storm.time_offset = datetime.datetime(2001, 10, 9, 2)
