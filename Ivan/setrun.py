...
def setrun(claw_pkg='geoclaw'):
    ...
    if clawdata.output_style == 1:
        ...
        clawdata.tfinal = days2seconds(7)
        recurrence = 8
    ...
    amrdata.amr_levels_max = 6 # up to 7
...
def setgeo(rundata):
    ...
    clawutil.data.get_remote_file(
                   "http://ftp.nhc.noaa.gov/atcf/archive/2004/bal092004.dat.gz")
    atcf_path = os.path.join(scratch_dir, "bal092004.dat")
    ...
    # The storm passed over Grenada on September 7
    storm.time_offset = datetime.datetime(2004, 9, 7, 0)
